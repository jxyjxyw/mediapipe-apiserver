...
class TopdownPoseEstimator3D(TopdownPoseEstimator):
    ...
    def add_pred_to_datasample(self, batch_pred_instances: InstanceList,
        ...
        for pred_instances, pred_fields, data_sample in zip_longest(
            ...
            # keypoints_simcc[..., :2] = keypoints_simcc[..., :2] / input_size * input_scale + input_center - 0.5 * input_scale
            ...
            if gt_instances.get('camera_params', None) is not None:
                ...
                f = np.array([524.575439453125, 524.575439453125])
            ...
            kpts_cam[..., :2] = (kpts_pixel[..., :2] - c) / f * kpts_pixel[...,
                                                                           2:]
            # print(kpts_cam[:, :17])
            # print(keypoints_3d[:, :17])
            # print(keypoints_simcc[:, :17])
            # print(keypoints_2d[:, :17])
            if mode == '3d':
